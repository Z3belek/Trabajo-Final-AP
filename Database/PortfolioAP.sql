...
-- Volcando estructura de base de datos para portfolioap
CREATE DATABASE IF NOT EXISTS `portfolioap` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `portfolioap`;

-- Volcando estructura para tabla portfolioap.zz_aboutme
...
-- Volcando estructura para tabla portfolioap.zz_education
...
-- Volcando estructura para tabla portfolioap.zz_experience
...
-- Volcando estructura para tabla portfolioap.zz_project
